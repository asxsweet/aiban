...
export const DEFAULT_CONFIG: LoveConfig = {
  ...
  awardText: "Мен әлемдегі ең бақытты жанмын себебі сіздей аруды жолықтырғаныма өте өте қуаныштымын,сіздің мейірімділігіңіз және сізден шыққан әр бір сөз мен үшін сондай жақын,шынымды айтсам сіз менің үлкен бақытымсыз,сіз барда барлығы әдемірек және жеңілірек,сіздің менің өмірімде барыңызға рақмет",
  signatureText: "мен сізді қатты жақсы көремін",
  awardDate: "06 маусым 2026",
  
  gift1Title: "Жүрегім,Сұлуым",
  gift1Text: "Сізбен өткізген әрбір уақыт маған маңызды,ценю және сізді өте өте қатты жақсы көремін",
